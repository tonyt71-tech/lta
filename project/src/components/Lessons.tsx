      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white/90 text-green-900 p-8 rounded-lg shadow-xl mb-16">
          ...
          <ul className="list-disc list-inside text-left text-xl space-y-4">
            ...
            <li>
              <span className="inline-block bg-green-800 text-yellow-200 px-3 py-1 rounded-md font-semibold">
        ...
        <div className="bg-white/90 text-green-900 p-8 rounded-lg shadow-xl">
          ...
          <ul className="list-disc list-inside text-left text-xl space-y-4">
            <li>
              <strong>1-on-1 Private Lesson:</strong> $25 per hour
            </li>
            <li>
              <strong>Semi-Private (2 players):</strong> $18 per person ($36/hr)
            </li>
            <li>
              <strong>Semi-Private (3 players):</strong> $15 per person ($45/hr)
            </li>
            <li>
              <strong>Small Group (4 players):</strong> $12 per person ($48/hr)
            </li>
            <li>
              <strong>Small Group (5 players):</strong> $10 per person ($50/hr)
            </li>
            <li>
              <strong>Small Group (6 players):</strong> $9 per person ($54/hr)
            </li>
          </ul>
        </div>
      </div>
